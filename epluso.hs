...
oddPlusOdd (NextOdd n) m = oddPlusOne (evenPlusOne (oddPlusOdd n m))

-- | Proves even + odd = odd
evenPlusOdd :: Even n -> Odd m -> Odd (Add n m)
evenPlusOdd ZeroEven m = m
evenPlusOdd (NextEven n) m = evenPlusOne (oddPlusOne (evenPlusOdd n m))

-- | Proves odd + even = odd
oddPlusEven :: Odd n -> Even m -> Odd (Add n m)
oddPlusEven OneOdd m = evenPlusOne m
-- oddPlusEven a b = undefined
oddPlusEven (NextOdd n) m = evenPlusOne (oddPlusOne (oddPlusEven n m))
